 ...
 * ProjectName     :     android_middle_parent_new
 * CompanyInfo     ：    Copyright 2018 Shanghai 17zuoye technology co., LTD.
 * @author         :     mh.wang
 * @version        :     v2.0
 * @date           :     2018/12/29 3:24
 * Description     :     适配有虚拟键盘的布局：屏幕适配华为等部分手机
 * ==================================================
 * </pre>
 **/
public class NavigationBarUtil {
    ...
    private NavigationBarUtil(View content) {
        ...
        mObserved.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver
