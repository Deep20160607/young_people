...
package com.young.library.net.cookie.store;

import android.content.Context;
import android.content.SharedPreferences;
import android.text.TextUtils;

import com.young.library.net.cookie.SerializableCookie;
...
public class SPCookieStore implements CookieStore {
    ...
    /**
     * 保存cookie,并将cookies已sp的形式持久化到本地
     *
     * @param url
     * @param cookie
     * @param cookieToken
